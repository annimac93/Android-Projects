...
public class DBO extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table tbluser"+"(userid integer primary key autoincrement, username text, name text, email text, mobile text,password text,photo blob )");
    ...
    public boolean addUser(String username, String name, String email, String mobile, String password, byte[] bytePhoto)
    {
